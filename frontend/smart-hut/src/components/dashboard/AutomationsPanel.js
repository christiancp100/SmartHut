...
const Automation = ({
  ...
  //Style of trigger and condition tags
  const spaceBetweenTags = {
    margin: "0.5rem 1rem"
  }
              ...
              <Grid.Column>
                ...
                <List divided relaxed>
                  ...
                  && triggers.map((trigger) => {
                    ...
                    return (
                      <Menu key={trigger.id} compact style={spaceBetweenTags}>
                        <Menu.Item as="span">
                          {device.name}
                          {' '}
                          {trigger.operator
              ...
              <Grid.Column>
                ...
                <List divided relaxed>
                  ...
                  && scenePriorities.map((sp) => {
                    ...
                    if (!sceneData) return '';
                    return (
                      <Menu key={sceneData.id} compact style={spaceBetweenTags}>
              ...
              <Grid.Column>
                ...
                <List divided relaxed>
                  ...
                  && conditions.map((condition) => {
                    ...
                    return (
                      <Menu key={condition.id} compact style={spaceBetweenTags}>
                        <Menu.Item as="span">
                          {device.name}
                          {' '}
                          {condition.operator
